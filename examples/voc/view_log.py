...
def print_bar(title='', width=80):
    ...
    print('=' * int(width // 2 - 1 - length_left) +
          title + '=' * int(width // 2 - length_right))


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--log_file', default='/home/zhangli/20181007_pytorch-fcn/examples/voc/logs/MODEL-fcn8s_CFG-001_MAX_ITERATION-100000_LR-1e-14_MOMENTUM-0.99_WEIGHT_DECAY-0.0005_INTERVAL_VALIDATE-4000_VCS-aa8d9b5_TIME-20181008-220749/log.csv')
